...
class Util {
  ...
  static String _generateClassFromMap(
    ...
    jsonMap.forEach((key, value) {
      classBuffer.writeln(
          "     ${_convertToValidVariableName(key)}: ${_convertToJsonMapper(key, value)},");
    });
    classBuffer.writeln("   );");
    classBuffer.writeln(" }");
    classBuffer.writeln("");
  ...
  static getClassName(String className) {
    return className.trim().isEmpty ? "AutoGenerated" : className;
  }

  static Future<void> initiateDownload(String fileName, String content) async {
